...
function sourceBundle(format, version, difficultyBytes, audio) {
  ...
  return Object.freeze({
    manifest: Object.freeze({ schemaId: "aerobeat.beatsaver-source-manifest.v2",infoFormatMajor:major===4?4:2,infoFormat:major===4?"v4":"v2",infoVersion:major===4?"4.0.0":"2.1.0", infoPath: "Info.dat",hashInputPaths:Object.freeze(["Hard.dat"]), songName: `Task 11 ${format}`,songSubName:"", songAuthorName: "AeroBeat", levelAuthorName: "AeroBeat", bpm: 120, audioPath: "song.ogg",coverPath:"",previewStartSeconds:0,previewDurationSeconds:0, difficulties: Object.freeze([Object.freeze({ characteristic: "Standard", difficulty: "Hard",difficultyRank:5, path: "Hard.dat",beatMapFormatMajor:major,beatMapFormat:format,beatMapVersion:version,notePalette:null,noteJumpMovementSpeed:10,noteJumpStartBeatOffset:0 })]),entries:Object.freeze([]),archiveBytes:0,expandedBytes:0 }),
