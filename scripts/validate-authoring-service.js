...
assert.deepEqual([first.package.schemaId,first.package.schemaVersion,first.package.packageVersion],["aerobeat.song-package.v6",6,"6.0.0"]);
assert.deepEqual([flowChart.schemaId,flowChart.schemaVersion],["aerobeat.chart.flow.v5",5]);
...
function sourceBundleForDocument(format, document) {
  ...
  return Object.freeze({
    manifest: Object.freeze({ schemaId: "aerobeat.beatsaver-source-manifest.v2", infoFormatMajor: format==="v4"?4:2, infoFormat:format==="v4"?"v4":"v2",infoVersion:format==="v4"?"4.0.0":"2.1.0", infoPath: "Info.dat",hashInputPaths:Object.freeze([path]), songName: "Synthetic Golden",songSubName:"", songAuthorName: "AeroBeat", levelAuthorName: "AeroBeat", audioPath: "song.ogg",coverPath:"", bpm: 120,previewStartSeconds:0,previewDurationSeconds:0, difficulties: Object.freeze([{ characteristic: "Standard", difficulty: "Hard",difficultyRank:5, path,beatMapFormatMajor:Number(format.slice(1)),beatMapFormat:format,beatMapVersion:format==="v2"?"2.6.0":format==="v3"?"3.3.0":"4.0.0",notePalette:null,noteJumpMovementSpeed:10,noteJumpStartBeatOffset:0 }]), entries: Object.freeze([]),archiveBytes:0,expandedBytes:0 }),
