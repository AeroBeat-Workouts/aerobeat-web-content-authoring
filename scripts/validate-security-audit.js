...
const migrated = createIndexedDbPersistenceAdapter({ indexedDB, databaseName: oldName }); assert.equal((await migrated.get("old"))?.sourceCache.length, 0); migrated.destroy();
