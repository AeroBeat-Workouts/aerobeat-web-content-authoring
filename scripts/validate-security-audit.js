...
const migrated = createIndexedDbPersistenceAdapter({ indexedDB, databaseName: oldName }); assert.equal(await migrated.get("old"), null, "pre-v4 packages must be invalidated because their Flow orientation is not trustworthy"); migrated.destroy();
