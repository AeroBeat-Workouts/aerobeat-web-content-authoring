...
function sourceBundle(notePalette,beatMapFormat="v3"){const entries=new Map([["info.dat",infoBytes],["hard.dat",difficultyBytes],["song.ogg",audioBytes]]);return Object.freeze({manifest:Object.freeze({schemaId:"aerobeat.beatsaver-source-manifest.v2",infoFormatMajor:2,infoFormat:"v2",infoVersion:"2.1.0",infoPath:"Info.dat",songName:"Palette",songAuthorName:"AeroBeat",levelAuthorName:"AeroBeat",audioPath:"song.ogg",bpm:120,difficulties:Object.freeze([{characteristic:"Standard",difficulty:"Hard",path:"Hard.dat",beatMapFormat,beatMapVersion:"3.3.0",notePalette}]),entries:Object.freeze([])}),listEntryPaths(){return Object.freeze(["Info.dat","Hard.dat","song.ogg"]);},readEntry(path){const bytes=entries.get(path.toLowerCase());if(!bytes)throw new Error("missing entry");return Uint8Array.from(bytes);}});}
/** @param {string} code */
