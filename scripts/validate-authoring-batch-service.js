...
function sourceBundle() {
  ...
  return Object.freeze({
    manifest: Object.freeze({ schemaId: "aerobeat.beatsaver-source-manifest.v2",infoFormatMajor:2,infoFormat:"v2",infoVersion:"2.1.0", infoPath: "Info.dat", songName: "Batch Song", songAuthorName: "AeroBeat", levelAuthorName: "AeroBeat", audioPath: "song.ogg", bpm: 120, difficulties: Object.freeze([{ characteristic: "Standard", difficulty: "Expert", path: "Expert.dat",beatMapFormat:"v3",beatMapVersion:"3.3.0",notePalette:null }, { characteristic: "Lightshow", difficulty: "ExpertPlus", path: "Lights.dat" }, { characteristic: "Standard", difficulty: "Hard", path: "Hard.dat",beatMapFormat:"v3",beatMapVersion:"3.3.0",notePalette:null }]), entries: Object.freeze([]) }),
