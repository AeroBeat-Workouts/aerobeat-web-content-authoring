...
function obstacleContractForPackage(packageValue){
  if(valueFor(packageValue,"schemaId")!=="aerobeat.song-package.v3"||valueFor(packageValue,"schemaVersion")!==3||valueFor(packageValue,"packageVersion")!=="3.0.0")return legacyObstacleContract;
  ...
  const flow=flowCharts[0];if(valueFor(flow,"schemaId")!=="aerobeat.chart.flow.v3"||valueFor(flow,"schemaVersion")!==3||valueFor(flow,"rulesetId")!=="flow_grid_v2")return legacyObstacleContract;
